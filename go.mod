...
require (
	...
	github.com/openstack-k8s-operators/lib-common/modules/common v0.3.1-0.20231218151156-f8b6875112d7
	github.com/openstack-k8s-operators/lib-common/modules/openstack v0.3.1-0.20231218151156-f8b6875112d7
	github.com/openstack-k8s-operators/lib-common/modules/test v0.3.1-0.20231218151156-f8b6875112d7
